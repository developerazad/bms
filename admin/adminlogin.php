...
<body>
	...
	<div class="container">
		<div class="header_top">
			...
			<!-- <span style="font-size:50px;color:#2c2f84;font-weight: bolder;margin-left: 50px;">Donate Blood, Save Life</span> -->
		</div>
		...
		<!-- <h1 class="text-center" style="background-color:;color: #fff;">Admin Panel</h1> -->
			<div class="formstyle" style="padding: 10px;border: 1px solid lightgrey;margin-right: 376px;margin-left: 406px; margin-bottom: 25px;background-color:black;">
				<form action="" method="post" class="text-center">
					...
					<button name="submit" type="submit" style="margin-left: 210px;margin-top: 3px;;padding: 5px 25px; border-radius: 4px;">Login</button> <br>
				...
				if(isset($_POST["submit"])){
							...
							$result = $conn->query($sql);
									...
									if ($result->num_rows > 0) {
										    ...
										    echo "<script>location.replace('donor.php');</script>";
